...
- Exact cleanup commands and behaviour for Yarn, Cypress, Playwright, NuGet, Cargo, Gradle, Maven, and Docker. The implemented Bun, npm, pnpm, and uv slices have bounded evidence only for the version gates and scopes recorded below.

...
- Not yet exercised through the Windows UI: cancelling an in-flight measurement, and the background-measurement notice shown when viewing a different project while one is still being measured. M4.4 remains unauthorized until those are confirmed or explicitly accepted as deferred.

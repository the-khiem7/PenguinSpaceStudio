...
- No project file or directory was created, modified, or removed by discovery. The artifact has not been launched, so Windows visual acceptance of the Projects surface remains open, and M4.2 measurement is not authorized by this checkpoint.
